...
class AddTempleColor extends StatefulWidget {
  const AddTempleColor({super.key});

  @override
  State<AddTempleColor> createState() => _AddTempleColorState();
}

class _AddTempleColorState extends State<AddTempleColor> {
  ...
  Future<void> _addTempleColor() async {
    final colorName = _colorNameController.text.trim();
    if (colorName.isEmpty) {
      _showSnackBar("Temple Color name cannot be empty", Colors.redAccent);
      return;
    }
  ...
  Future<void> _exportSelectedToPDF(
    ...
    try {
      ...
      final file = File("${dir.path}/TempleColors.pdf");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Temple Colors'),
        centerTitle: true,
        backgroundColor: const Color(0xFF1976D2),
